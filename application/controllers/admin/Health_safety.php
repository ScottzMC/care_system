    ...
    class Health_safety extends CI_Controller{
        ...
        public function index(){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                $data['health_safety'] = $this->Health_safety_model->display_all_health_safety();
                $data['children'] = $this->Health_safety_model->display_all_children();

                $this->load->view('admin/health_safety/view', $data);
            }else{
        ...
        public function detail($id){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/health_safety/detail', $data);
            }else{
                redirect('admin/account/login');    
            }
        }
        ...
        public function add(){
            ...
            if($insert){ ?>
                <script>
                    ...
                    window.location.href="<?php echo site_url('admin/health_safety'); ?>";
                </script>
      <?php }else{ ?>
               <script>
                    alert('Failed');
      ...
      <?php }
        ...
        public function edit($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/health_safety/edit', $data);
        ...
        public function edit_image1($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/health_safety/image1', $data);
        ...
        public function edit_image2($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/health_safety/image2', $data);
        ...
        public function edit_image3($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/health_safety/image3', $data);
        ...
        public function edit_image4($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/health_safety/image4', $data);
        ...
        public function edit_image5($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/health_safety/image5', $data);
        ...
        public function search(){
          ...
          $data["search"] = $this->Health_safety_model->fetch_search_data($search_query);

          $this->load->view('admin/health_safety/search', $data);
        }
