        ...
        public function add(){
            ...
            if($insert_support_work){ ?>
                <script>
                    ...
                    window.location.href="<?php echo site_url('admin/support_work'); ?>";
                </script>
      <?php }else{ ?>
               <script>
                    alert('Failed');
      ...
      <?php }
        ...
        public function edit_task($id){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/support_work/edit_task', $data);
      ...
      <?php }
        ...
        public function edit_subtask($id){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/support_work/edit_subtask', $data);
