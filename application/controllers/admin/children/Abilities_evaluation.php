<?php 
    ...
    class Abilities_evaluation extends CI_Controller{
                ...
                if(isset($btn_submit)){
                    ...
                    ?>
                        <script>
                            ...
                            window.location.href="<?php echo site_url('admin/children/abilities_evaluation/view/'.$code); ?>";
                        </script>
                  <?php }else{ ?>
                           <script>
                                alert('Failed');
        ...
        <script>
            alert("Sent to Mail");
            window.location.href="<?php echo site_url('admin/children/abilities_evaluation/detail/'.$id.'/'.$code); ?>";
        </script> 
 <?php }
