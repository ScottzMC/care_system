    ...
    class Edt extends CI_Controller{
        ...
        public function view($code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/children/edt/view', $data);
            }else{
        ...
        public function detail($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/children/edt/detail', $data);
            }else{
                redirect('admin/account/login');    
            }
        }
        ...
        public function add(){
            ...
            if(isset($btn_submit)){
                ...
                for($i=0; $i<$cpt1; $i++){
                    ...
                    $config1 = array(
                        'upload_path'   => "./uploads/children/edt/",
                ...
                */
                ...
                if($add){ ?>
                    <script>
                        ...
                        window.location.href="<?php echo site_url('admin/children/edt/view/'.$child_code); ?>";
                    </script>
              <?php }else{ ?>
                    <script>
                        alert('Failed');
        ...
        public function edit($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/children/edt/edit', $data);
                ...
                if(isset($btn_submit)){
                    ...
                    ?>
                        <script>
                            ...
                            window.location.href="<?php echo site_url('admin/children/edt/view/'.$code); ?>";
                        </script>
                  <?php }else{ ?>
                           <script>
                                alert('Failed');
        ...
        public function send_mail($id, $code){
          ...
          $subject = "Edt";
          $body = "Please find below attached the Edt document";
         ...
         $atch = base_url('uploads/children/edt/'.$pdf);
        ...
        <script>
            alert("Sent to Mail");
            window.location.href="<?php echo site_url('admin/children/edt/detail/'.$id.'/'.$code); ?>";
        </script> 
 <?php }
