    ...
    class Finance_information extends CI_Controller{
        ...
        public function view($code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/children/finance_information/view', $data);
            }else{
        ...
        public function detail($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/children/finance_information/detail', $data);
            }else{
                redirect('admin/account/login');    
            }
        }
            ...
            if(isset($btn_submit)){
                ...
                if($add){ ?>
                    <script>
                        ...
                        window.location.href="<?php echo site_url('admin/children/finance_information/view/'.$child_code); ?>";
                    </script>
              <?php }else{ ?>
                       <script>
                            alert('Failed');
        ...
        public function edit($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/children/finance_information/edit', $data);
        ...
        public function search(){
          ...
          $data['children'] = $this->Children_model->display_all_children();
          $data["search"] = $this->Children_model->fetch_search_finance_data($search_query);

          $this->load->view('admin/children/finance_information/search', $data);
        }
        ...
        public function send_mail(){
          ...
          $body = "
            Please find below the information of the Finance Information - 
            Title - $title
