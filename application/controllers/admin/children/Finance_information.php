<?php 
    ...
    class Finance_information extends CI_Controller{
                ...
                if(isset($btn_submit)){
                    ...
                    ?>
                        <script>
                            ...
                            window.location.href="<?php echo site_url('admin/children/finance_information/view/'.$code); ?>";
                        </script>
                  <?php }else{ ?>
                           <script>
                                alert('Failed');
        ...
        <script>
            alert("Sent to Mail");
            window.location.href="<?php echo site_url('admin/children/finance_information/detail/'.$id.'/'.$code); ?>";
        </script> 
 <?php }
