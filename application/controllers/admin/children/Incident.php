    ...
    class Incident extends CI_Controller{
        ...
        public function view($code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/children/incident/view', $data);
            }else{
        ...
        public function detail($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/children/incident/detail', $data);
            }else{
                redirect('admin/account/login');    
            }
        }
            ...
            if(isset($btn_submit)){
                ...
                if($add){ ?>
                    <script>
                        ...
                        window.location.href="<?php echo site_url('admin/children/incident/view/'.$child_code); ?>";
                    </script>
              <?php }else{ ?>
                       <script>
                            alert('Failed');
        ...
        public function edit($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/children/incident/edit', $data);
                ...
                if(isset($btn_submit)){
                    ...
                    ?>
                        <script>
                            ...
                            window.location.href="<?php echo site_url('admin/children/incident/view/'.$code); ?>";
                        </script>
                  <?php }else{ ?>
                           <script>
                                alert('Failed');
        ...
        <script>
            alert("Sent to Mail");
            window.location.href="<?php echo site_url('admin/children/incident/detail/'.$id.'/'.$code); ?>";
        </script> 
 <?php }
