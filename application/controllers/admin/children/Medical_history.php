    ...
    class Medical_history extends CI_Controller{
        ...
        public function view($code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $data['medical'] = $this->Children_model->display_medical_report_by_code($code);
                
                $this->load->view('admin/children/medical_history/view', $data);
            }else{
        ...
        public function detail($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $data['medical'] = $this->Children_model->display_medical_report_by_id($id);
                
                $this->load->view('admin/children/medical_history/detail', $data);
            }else{
                redirect('admin/account/login');    
            }
        }
        ...
        public function add(){
            ...
            if(isset($btn_submit)){
                ...
                for($i=0; $i<$cpt1; $i++){
                    ...
                    $config1 = array(
                        'upload_path'   => "./uploads/children/medical_history/",
                ...
                */
                ...
                $add_medical_history = $this->Children_model->insert_medical_history($array);
                
                if($add_medical_history){ ?>
                    <script>
                        alert('Added Successfully');
                        window.location.href="<?php echo site_url('admin/children/medical_history/view/'.$child_code); ?>";
                    </script>
              <?php }else{ ?>
                   <script>
                        alert('Failed');
        ...
        public function edit($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/children/medical_history/edit', $data);
                ...
                if(isset($btn_submit)){
                    ...
                    $update_medical_history = $this->Children_model->update_medical_history_details($id, $array);
                    ...
                    ?>
                        <script>
                            ...
                            window.location.href="<?php echo site_url('admin/children/medical_history/view/'.$code); ?>";
                        </script>
                  <?php }else{ ?>
                           <script>
                                alert('Failed');
        ...
        public function delete(){
           ...
           $this->Children_model->delete_medical_history($id); 
        }
        ...
        public function send_mail($id, $code){
          ...
          $body = "Please find below attached the Medical History document";
        ...
        <script>
            alert("Sent to Mail");
            window.location.href="<?php echo site_url('admin/children/medical_history/detail/'.$id.'/'.$code); ?>";
        </script> 
 <?php }
        ...
        public function edit_document($id, $code){
            ...
            $update = $this->Children_model->update_medical_history_details($id, $array);
      ...
      <?php }
        ...
        public function download($id){
          ...
          $query = $this->db->query("SELECT document FROM children_medical_history WHERE id = '$id' ")->result();
          foreach($query as $qry){}
            
          //$data = file_get_contents($file_name);
          $file = 'uploads/medical_history/'.$qry->document;
