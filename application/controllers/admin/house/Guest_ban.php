    ...
    class Guest_ban extends CI_Controller{
        ...
        public function view($code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/house/guest_ban/view', $data);
            }else{
                ...
                if(isset($submit_btn)){
                    ...
                    if($insert){ ?>
                        <script>
                            ...
                            window.location.href="<?php echo site_url('admin/house/guest_ban/view/'.$house_code); ?>";
                        </script>
              <?php }else{ ?>
                       <script>
                            alert('Failed');
        ...
        <script>
            alert("Sent to Mail");
            window.location.href="<?php echo site_url('admin/house/guest_ban/view/'.$code); ?>";
        </script> 
 <?php }
