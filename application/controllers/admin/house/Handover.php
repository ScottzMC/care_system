        ...
        public function ingoing($code){
            ...
            if($handover_id == $ingoing_code){ ?>
                <script>
                    ...
                    window.location.href="<?php site_url('admin/house/handover/add/'.$code); ?>";
                </script>
            <?php }
            ...
            if($insert && $ingoing){ ?>
                <script>
                    ...
                    window.location.href="<?php echo site_url('admin/house/handover/view/'.$code); ?>";
                </script>
      <?php }else{ ?>
               <script>
                    alert('Failed');
      ...
      <?php }
        ...
        public function outgoing($code){
            ...
            if($insert && $outgoing){ ?>
                <script>
                    alert('Added Successfully');
                    window.location.href="<?php echo site_url('admin/house/handover/add/'.$code); ?>";
                </script>
      <?php }else{ ?>
               <script>
                    alert('Failed');
        ...
        public function edit_document($id, $code){
            ...
            if($update){ ?>
                <script>
                    ...
                    window.location.href="<?php echo site_url('admin/house/handover/detail/'.$id.'/'.$code); ?>";
                </script>
      <?php }else{ ?>
               <script>
                    alert('Failed');
