    ...
    class Keywork_session extends CI_Controller{
        ...
        public function view($code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/house/keywork_session/view', $data);
            }else{
        ...
        public function detail($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/house/keywork_session/detail', $data);
            }else{
                redirect('admin/account/login');    
            }
        }
        ...
        public function add($code){
            ...
            $this->load->view('admin/house/keywork_session/add', $data);
      ...
      <?php }
        ...
        public function edit($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/house/keywork_session/edit', $data);
        ...
        public function edit_independent_living($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/house/keywork_session/independent_living', $data);
        ...
        public function edit_image1($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/house/keywork_session/image1', $data);
        ...
        public function edit_image2($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/house/keywork_session/image2', $data);
        ...
        public function edit_image3($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/house/keywork_session/image3', $data);
        ...
        public function edit_image4($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/house/keywork_session/image4', $data);
        ...
        public function edit_image5($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Admin"){
                ...
                $this->load->view('admin/house/keywork_session/image5', $data);
        ...
        public function send_mail($id, $code){
          ...
          $body = "Please find below attached the Keywork Session document";
         ...
         $atch = base_url('uploads/keywork_session/'.$pdf);
