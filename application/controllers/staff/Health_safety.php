    ...
    class Health_safety extends CI_Controller{
        ...
        public function index(){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/health_safety/view', $data);
            }else{
        ...
        public function detail($id){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/health_safety/detail', $data);
            }else{
                redirect('staff/account/login');    
            }
        }
        ...
        public function add(){
            ...
            if($insert){ ?>
                <script>
                    ...
                    window.location.href="<?php echo site_url('staff/health_safety'); ?>";
                </script>
      <?php }else{ ?>
               <script>
                    alert('Failed');
      ...
      <?php }
        ...
        public function edit($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/health_safety/edit', $data);
        ...
        public function edit_image1($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/health_safety/image1', $data);
        ...
        public function edit_image2($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/health_safety/image2', $data);
        ...
        public function edit_image3($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/health_safety/image3', $data);
        ...
        public function edit_image4($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/health_safety/image4', $data);
        ...
        public function edit_image5($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/health_safety/image5', $data);
        ...
        public function search(){
          ...
          $this->load->view('staff/health_safety/search', $data);
        }
