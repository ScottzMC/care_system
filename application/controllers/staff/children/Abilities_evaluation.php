    ...
    class Abilities_evaluation extends CI_Controller{
        ...
        public function view($code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/children/abilities_evaluation/view', $data);
            }else{
        ...
        public function detail($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/children/abilities_evaluation/detail', $data);
            }else{
                redirect('staff/account/login');    
            }
        }
            ...
            if(isset($btn_submit)){
                ...
                if($add){ ?>
                    <script>
                        ...
                        window.location.href="<?php echo site_url('staff/children/abilities_evaluation/view/'.$child_code); ?>";
                    </script>
              <?php }else{ ?>
                       <script>
                            alert('Failed');
        ...
        public function edit($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/children/abilities_evaluation/edit', $data);
                ...
                if(isset($btn_submit)){
                    ...
                    ?>
                        <script>
                            ...
                            window.location.href="<?php echo site_url('staff/children/abilities_evaluation/view/'.$code); ?>";
                        </script>
                  <?php }else{ ?>
                           <script>
                                alert('Failed');
        ...
        public function send_mail($id, $code){
          ...
          $body = "Please find below attached the Abilities Evaluation document";
         ...
         $atch = base_url('uploads/children/abilities_evaluation/'.$pdf);
        ...
        <script>
            alert("Sent to Mail");
            window.location.href="<?php echo site_url('staff/children/abilities_evaluation/detail/'.$id.'/'.$code); ?>";
        </script> 
 <?php }
        ...
        public function edit_document($id, $code){
            ...
            for($i=0; $i<$cpt1; $i++){
                ...
                $config1 = array(
                    'upload_path'   => "./uploads/children/abilities_evaluation/",
                    //'upload_path'   => "./uploads/../../uploads/community/",
                    'allowed_types' => "pdf|docx|doc",
                    'overwrite'     => TRUE,
                    'max_size'      => "30000",  // Can be set to particular file size
