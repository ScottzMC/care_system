    ...
    class Case_recording extends CI_Controller{
        ...
        public function view($code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/children/case_recording/view', $data);
            }else{
        ...
        public function detail($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/children/case_recording/detail', $data);
            }else{
                redirect('staff/account/login');    
            }
        }
        ...
        public function add(){
            ...
            if(isset($btn_submit)){
                ...
                for($i=0; $i<$cpt1; $i++){
                    ...
                    $config1 = array(
                        'upload_path'   => "./uploads/case_recording/",
                ...
                if($add){ ?>
                    <script>
                        ...
                        window.location.href="<?php echo site_url('staff/children/case_recording/view/'.$child_code); ?>";
                    </script>
              <?php }else{ ?>
                       <script>
                            alert('Failed');
        ...
        public function edit($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/children/case_recording/edit', $data);
        ...
        public function search(){
          ...
          $data['children'] = $this->Children_model->display_all_children();
          $data["search"] = $this->Children_model->fetch_search_case_recording_data($search_query);

          $this->load->view('staff/children/case_recording/search', $data);
        }
        ...
        public function send_mail(){
          ...
          $body = "
            Please find below the information of the Case Recording - 
            Title - $title
