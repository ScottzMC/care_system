    ...
    class Contact_detail extends CI_Controller{
        ...
        public function view($code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/children/contact_detail/view', $data);
            }else{
        ...
        public function detail($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/children/contact_detail/detail', $data);
            }else{
                redirect('staff/account/login');    
            }
        }
            ...
            if(isset($btn_submit)){
                ...
                if($add){ ?>
                    <script>
                        ...
                        window.location.href="<?php echo site_url('staff/children/contact_detail/view/'.$child_code); ?>";
                    </script>
              <?php }else{ ?>
                   <script>
                        alert('Failed');
        ...
        public function edit($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/children/contact_detail/edit', $data);
        ...
        <script>
            alert("Sent to Mail");
            window.location.href="<?php echo site_url('staff/children/contact_detail/detail/'.$id.'/'.$code); ?>";
        </script> 
 <?php }
