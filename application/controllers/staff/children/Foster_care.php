<?php 
    ...
    class Foster_care extends CI_Controller{
        ...
        public function view($code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $data['foster'] = $this->Children_model->display_foster_care_by_code($code);
                
                $this->load->view('staff/children/foster_care/view', $data);
            }else{
        ...
        public function detail($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $data['foster'] = $this->Children_model->display_foster_care_by_id($id);
                
                $this->load->view('staff/children/foster_care/detail', $data);
            }else{
                redirect('staff/account/login');    
            }
        }
        ...
        public function add(){
            ...
            if(isset($btn_submit)){
                ...
                for($i=0; $i<$cpt1; $i++){
                    ...
                    $config1 = array(
                        'upload_path'   => "./uploads/foster_care/",
                ...
                */
                ...
                $add = $this->Children_model->insert_foster_care($array);
                
                if($add){ ?>
                    <script>
                        alert('Added Successfully');
                        window.location.href="<?php echo site_url('staff/children/foster_care/view/'.$child_code); ?>";
                    </script>
              <?php }else{ ?>
                       <script>
                            alert('Failed');
        ...
        public function edit($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/children/foster_care/edit', $data);
                ...
                if(isset($btn_submit)){
                    ...
                    $update = $this->Children_model->update_foster_care_details($id, $array);
                    ...
                    ?>
                        <script>
                            ...
                            window.location.href="<?php echo site_url('staff/children/foster_care/view/'.$code); ?>";
                        </script>
                  <?php }else{ ?>
                           <script>
                                alert('Failed');
        ...
        public function send_mail($id, $code){
          ...
          $subject = "Foster Care";
          $body = "Please find below attached the Foster Care document";
         ...
         $atch = base_url('uploads/children/foster_care/'.$pdf);
        ...
        <script>
            alert("Sent to Mail");
            window.location.href="<?php echo site_url('staff/children/foster_care/detail/'.$id.'/'.$code); ?>";
        </script> 
 <?php }
        ...
        public function edit_document($id, $code){
            ...
            for($i=0; $i<$cpt1; $i++){
                ...
                $config1 = array(
                    'upload_path'   => "./uploads/children/foster_care/",
                    //'upload_path'   => "./uploads/../../uploads/community/",
                    'allowed_types' => "pdf|docx|doc",
                    'overwrite'     => TRUE,
                    'max_size'      => "30000",  // Can be set to particular file size
      ...
      <?php }
        ...
        public function delete(){
           ...
           $this->Children_model->delete_foster_care($id); 
        }
        
        public function download($id){
          //$file_name= $this->input->get('file_name');

          $query = $this->db->query("SELECT document FROM children_foster_care WHERE id = '$id' ")->result();
          foreach($query as $qry){}
            
          //$data = file_get_contents($file_name);
          $file = 'uploads/foster_care/'.$qry->document;
