<?php 
    ...
    class Incident extends CI_Controller{
        ...
        public function search(){
          ...
          $data['children'] = $this->Children_model->display_all_children();
          $data["search"] = $this->Children_model->fetch_search_incident_data($search_query);

          $this->load->view('staff/children/incident/search', $data);
        }
        ...
        public function send_mail(){
          ...
          $subject = "Incidents";
          $body = "
            Please find below the information of the Incident - 
            Title - $title
