<?php 
    ...
    class Medical_history extends CI_Controller{
        ...
        public function search(){
          ...
          $data['children'] = $this->Children_model->display_all_children();
          $data["search"] = $this->Children_model->fetch_search_medical_data($search_query);

          $this->load->view('staff/children/medical_history/search', $data);
        }
        ...
        public function send_mail(){
          ...
          $body = "
            Please find below the information of the Medical History - 
            Title - $title
