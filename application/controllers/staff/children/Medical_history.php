    ...
    class Medical_history extends CI_Controller{
        ...
        public function view($code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/children/medical_history/view', $data);
            }else{
        ...
        public function detail($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/children/medical_history/detail', $data);
            }else{
                redirect('staff/account/login');    
            }
        }
        ...
        public function add(){
            ...
            if(isset($btn_submit)){
                ...
                for($i=0; $i<$cpt1; $i++){
                    ...
                    $config1 = array(
                        'upload_path'   => "./uploads/medical_history/",
                ...
                if($add_medical_history){ ?>
                    <script>
                        ...
                        window.location.href="<?php echo site_url('staff/children/medical_history/view/'.$child_code); ?>";
                    </script>
              <?php }else{ ?>
                   <script>
                        alert('Failed');
        ...
        public function edit($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/children/medical_history/edit', $data);
        ...
        <script>
            alert("Sent to Mail");
            window.location.href="<?php echo site_url('staff/children/medical_history/detail/'.$id.'/'.$code); ?>";
        </script> 
 <?php }
