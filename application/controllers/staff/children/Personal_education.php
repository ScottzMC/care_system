<?php 
    ...
    class Personal_education extends CI_Controller{
        ...
        public function search(){
          ...
          $data['children'] = $this->Children_model->display_all_children();
          $data["search"] = $this->Children_model->fetch_search_education_data($search_query);

          $this->load->view('staff/children/personal_education/search', $data);
        }
        ...
        public function send_mail(){
          ...
          $body = "
            Please find below the information of the Personal Education - 
            Title - $title
