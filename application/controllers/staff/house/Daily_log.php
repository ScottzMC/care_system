    ...
    class Daily_log extends CI_Controller{
        ...
        public function detail($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/house/daily_log/detail', $data);
            }else{
                ...
                if(isset($submit)){
                    ...
                    if($insert){ ?>
                        <script>
                            ...
                            window.location.href="<?php echo site_url('staff/house/daily_log/detail/'.$last_id.'/'.$code); ?>";
                        </script>
                  <?php }else{ ?>
                       <script>
                            alert('Failed');
        ...
        public function edit($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/house/daily_log/edit', $data);
