    ...
    class Health_safety extends CI_Controller{
        ...
        public function detail($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/house/health_safety/detail', $data);
            }else{
                redirect('staff/account/login');    
            }
        }
        ...
        public function add($house_code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/house/health_safety/add', $data);
        ...
        public function edit($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/house/health_safety/edit', $data);
                ...
                if(isset($btn_submit)){
                  ...
                  <?php }else{ ?>
                       <script>
                            alert('Failed');
                            window.location.href="<?php echo site_url('staff/house/health_safety/'.$id.'/'.$code); ?>";
                        </script> 
                  <?php }  
                    }
            }else{
        ...
        public function edit_image1($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/house/health_safety/image1', $data);
        ...
        public function edit_image2($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/house/health_safety/image2', $data);
        ...
        public function edit_image3($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/house/health_safety/image3', $data);
        ...
        public function edit_image4($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/house/health_safety/image4', $data);
        ...
        public function edit_image5($id, $code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/house/health_safety/image5', $data);
