    ...
    class Keywork_session extends CI_Controller{
        ...
        public function view($code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/house/keywork_session/view', $data);
            }else{
        ...
        public function add($code){
            ...
            if($insert){ ?>
                <script>
                    ...
                    window.location.href="<?php echo site_url('staff/house/keywork_session/view/'.$code); ?>";
                </script>
      <?php }else{ ?>
               <script>
                    alert('Failed');
      ...
      <?php }
        ...
        public function independent_living($code){
            ...
            if($insert){ ?>
                <script>
                    alert('Added Successfully');
                    window.location.href="<?php echo site_url('staff/house/keywork_session/add/'.$code); ?>";
                </script>
      <?php }else{ ?>
               <script>
                    alert('Failed');
