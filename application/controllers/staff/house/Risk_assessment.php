<?php 
    ...
    class Risk_assessment extends CI_Controller{
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                if($insert_risk_assessment){ ?>
                    <script>
                        ...
                        window.location.href="<?php echo site_url('staff/house/risk_assessment/view/'.$house_code); ?>";
                    </script>
          <?php }else{ ?>
                   <script>
                        alert('Failed');
        ...
        <script>
            alert("Sent to Mail");
            window.location.href="<?php echo site_url('staff/house/risk_assessment/view/'.$code); ?>";
        </script> 
 <?php }
