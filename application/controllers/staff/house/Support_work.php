    ...
    class Support_work extends CI_Controller{
        ...
        public function view($code){
            ...
            if(!empty($session_role) && $session_role == "Staff"){
                ...
                $this->load->view('staff/house/support_work/view', $data);
            }else{
                ...
                if(isset($submit)){
                    ...
                    if($insert_support_work){ ?>
                        <script>
                            ...
                            window.location.href="<?php echo site_url('staff/house/support_work/view/'.$code); ?>";
                        </script>
              <?php }else{ ?>
                       <script>
                            alert('Failed');
        ...
        public function add_task($code){
            ...
            if($insert){ ?>
                <script>
                    alert('Added Successfully');
                    window.location.href="<?php echo site_url('staff/house/support_work/add/'.$code); ?>";
                </script>
      <?php }else{ ?>
               <script>
                    alert('Failed');
