...
<title>Edit <?php echo $abilities->child_name; ?> Young People || Admin || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Printout-edit">Edit <?php echo $abilities->child_name; ?> Young People</a></li>
                    ...
                    <div class="tab-pane active" id="Printout-edit">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit <?php echo $abilities->child_name; ?> Abilities Evaluation</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/children/abilities_evaluation/edit/'.$abilities->id.'/'.$abilities->code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Title <span class="text-danger">*</span></label>
                                                <input type="text" name="title" class="form-control" value="<?php echo $abilities->title; ?>">
                                            </div>
                                        </div>
