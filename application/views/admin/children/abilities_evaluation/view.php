...
<div id="main_content">
    ...
    <div class="page">
        ...
        function delete_abilities_evaluation(id){
          ...
          $.post('<?php echo base_url('admin/children/abilities_evaluation/delete'); ?>', {"del_id": del_id}, function(data){
                ...
                <div class="tab-content">
                            ...
                            <table class="table table-hover table-vcenter table-striped mb-0 text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url('admin/children/profile/detail/'.strtolower($abilities->code)); ?>"><span class="font-16"><?php echo $abilities->child_name; ?></span></a></td>
                    ...
                    <div class="tab-pane" id="Children-add">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/children/abilities_evaluation/add'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
