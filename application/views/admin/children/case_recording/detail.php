...
<title><?php echo $case->title; ?> Case Recording || Admin || Harold</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="timeline_item ">
                                            <form action="<?php echo base_url('admin/children/case_recording/send_mail/'.$case->id.'/'.$case->code); ?>" method="POST">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            <form action="<?php echo base_url('admin/generate_pdf/case_recording/'.$case->code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="timeline_item ">
                                            <form action="<?php echo base_url('admin/children/case_recording/edit_document/'.$case->id.'/'.$case->code); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
