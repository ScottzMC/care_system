...
<title><?php echo $contact->child_name; ?> Contact Details || Admin || Harold</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="timeline_item ">
                                                <form action="<?php echo base_url('admin/children/contact_detail/send_mail/'.$contact->id.'/'.$contact->code); ?>" method="POST">
                                ...
                                <div class="col-xl-8 col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="timeline_item">
                                                <form action="<?php echo base_url('admin/generate_pdf/contact_detail/'.$contact->code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                ...
                                <div class="col-xl-8 col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="timeline_item ">
                                                <form action="<?php echo base_url('admin/children/contact_detail/edit_document/'.$contact->id.'/'.$contact->code); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
