...
<div id="main_content">
    ...
    <div class="page">
                ...
                <div class="d-flex justify-content-between align-items-center ">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/children/profile/detail/'.$contact->code); ?>"><?php echo $contact->child_name; ?> Profile </a></li>
                            <?php } ?>
        ...
        function delete_contact_detail(id){
          ...
          $.post('<?php echo base_url('admin/children/contact_detail/delete'); ?>', {"del_id": del_id}, function(data){
                ...
                <div class="tab-content">
                            ...
                            <table class="table table-hover table-vcenter table-striped mb-0 text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url('admin/children/profile/detail/'.strtolower($contact->code)); ?>"><span class="font-16"><?php echo $contact->child_name; ?></span></a></td>
                                        <td><a href="<?php echo site_url('admin/children/contact_detail/detail/'.strtolower($contact->id).'/'.strtolower($contact->code)); ?>"><?php echo $contact->fullname; ?></a></td>
                                        <td><?php echo $contact->telephone; ?></td>
                                        <td><?php echo $contact->email; ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($contact->created_date)); ?></td>
                                        <td>
                                            <a href="<?php echo site_url('admin/children/contact_detail/detail/'.strtolower($contact->id).'/'.strtolower($contact->code)); ?>" class="btn btn-icon btn-sm" title="View"><i class="fa fa-eye"></i></a>
                                            <a href="<?php echo site_url('admin/children/contact_detail/edit/'.strtolower($contact->id).'/'.strtolower($contact->code)); ?>" class="btn btn-icon btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                    ...
                    <div class="tab-pane" id="Children-add">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/children/contact_detail/add'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
