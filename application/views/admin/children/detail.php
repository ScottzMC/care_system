                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
										...
										<ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                <b>Action</b>
                                                <div class="pull-right"><a href="<?php echo site_url("admin/children/profile/edit/$child->code"); ?>">Edit</a></div>
                                            </li>
                                        </ul>
                                    </div>
                                    <?php } ?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                       <div class="pull-right"><a href="<?php echo site_url("admin/children/medical_history/view/".$child->code); ?>">View All</a></div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                       <div class="pull-right"><a href="<?php echo site_url("admin/children/personal_education/view/".$child->code); ?>">View All</a></div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                       <div class="pull-right"><a href="<?php echo site_url("admin/children/finance_information/view/".$child->code); ?>">View All</a></div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                       <div class="pull-right"><a href="<?php echo site_url("admin/children/foster_care/view/".$child->code); ?>">View All</a></div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/children/foster_care/edit/$foster->id/$foster->code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                    <?php } } ?>
                                </div> 
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                       <div class="pull-right"><a href="<?php echo site_url("admin/children/incident/view/".$child->code); ?>">View All</a></div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <small class="float-right text-right"><a href="<?php echo site_url('admin/children/incident/edit/'.$inc->id.'/'.strtolower($inc->code)); ?>"> Edit</a></small>
                                        </div>
                                    </div>
                                    <?php } } ?>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                       <div class="pull-right"><a href="<?php echo site_url("admin/children/edt/view/".$child->code); ?>">View All</a></div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            ...
                                            <small class="float-right text-right"><a href="<?php echo site_url('admin/children/edt/edit/'.$abs->id.'/'.strtolower($abs->code)); ?>"> Edit</a></small>
                                        </div>
                                    </div>
                                    <?php } } ?>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                       <div class="pull-right"><a href="<?php echo site_url("admin/children/abilities_evaluation/view/".$child->code); ?>">View All</a></div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                       <div class="pull-right"><a href="<?php echo site_url("admin/children/case_recording/view/".$child->code); ?>">View All</a></div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header">
                                       <div class="pull-right"><a href="<?php echo site_url("admin/children/sanction_reward/view/".$child->code); ?>">View All</a></div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            ...
                                            <small class="float-right text-right"><a href="<?php echo site_url('admin/children/sanction_reward/edit/'.$sanc->id.'/'.strtolower($sanc->code)); ?>"> Edit</a></small>
                                        </div>
                                    </div>
                                    <?php } } ?>
                                </div>
