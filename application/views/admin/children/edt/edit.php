...
<title>Edit <?php echo $abs->child_name; ?> Young People || Admin || Harold</title>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Printout-edit">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/children/edt/edit/'.$abs->id.'/'.$abs->code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
