...
<div id="main_content">
    ...
    <div class="page">
                ...
                <div class="d-flex justify-content-between align-items-center ">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/children/profile/detail/'.$fin->code); ?>"><?php echo $fin->child_name; ?> Profile </a></li>
                            <?php } ?>
        ...
        function delete_finance_information(id){
          ...
          $.post('<?php echo base_url('admin/children/finance_information/delete'); ?>', {"del_id": del_id}, function(data){
        ...
        $(function(){
          $('#downloadable').click(function(){
             ...
             window.location.href = "<?php echo site_url('admin/children/finance_information/download') ?>?file_name="+ $(this).attr('href');
          });
        });
                ...
                <div class="tab-content">
                            ...
                            <table class="table table-hover table-vcenter table-striped mb-0 text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url('admin/children/profile/detail/'.strtolower($fin->code)); ?>"><span class="font-16"><?php echo $fin->child_name; ?></span></a></td>
                                        <td><a href="<?php echo site_url('admin/children/finance_information/detail/'.strtolower($fin->id).'/'.strtolower($fin->code)); ?>"><?php echo $fin->title; ?></a></td>
                                        <td><?php echo character_limiter($fin->body, 50); ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($fin->created_date)); ?></td>
                                        <!--<td>
                                        < ?php if(!empty($finance)){ ?>
                                        <a href="< ?php echo base_url('admin/children/finance_information/download/'.$fin->id); ?>" target="_blank">Download</a>
                                        < ?php }else{ echo ''; } ?>
                                        </td>-->
                                        <td>
                                            <a href="<?php echo site_url('admin/children/finance_information/detail/'.strtolower($fin->id).'/'.strtolower($fin->code)); ?>" class="btn btn-icon btn-sm" title="View"><i class="fa fa-eye"></i></a>
                                            <a href="<?php echo site_url('admin/children/finance_information/edit/'.strtolower($fin->id).'/'.strtolower($fin->code)); ?>" class="btn btn-icon btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                    ...
                    <div class="tab-pane" id="Children-add">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/children/finance_information/add'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="child_code">
                                                    ...
                                                    <option value="<?php echo $fin->code; ?>"><?php echo $fin->child_name; ?></option>
                                                </select>
                                            </div>
                                        </div>
