...
<title><?php echo $med->title; ?> Medical History || Admin || Harold</title>
    ...
    <div class="page">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/children/medical_history/view/'.$med->code); ?>">Medical History </a></li>
        ...
        $(function(){
          $('#downloadable').click(function(){
             ...
             window.location.href = "<?php echo site_url('admin/children/medical_history/download') ?>?file_name="+ $(this).attr('href');
          });
        });
        </script>
                            ...
                            <div class="col-xl-8 col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="timeline_item ">
                                                <form action="<?php echo base_url('admin/children/medical_history/send_mail/'.$med->id.'/'.$med->code); ?>" method="POST">
                                ...
                                <div class="col-xl-8 col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="timeline_item">
                                                <form action="<?php echo base_url('admin/generate_pdf/medical_history/'.$med->code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                ...
                                <div class="col-xl-8 col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="timeline_item ">
                                                <form action="<?php echo base_url('admin/children/medical_history/edit_document/'.$med->id.'/'.$med->code); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
