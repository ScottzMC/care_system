...
<div id="main_content">
    ...
    <div class="page">
                ...
                <div class="d-flex justify-content-between align-items-center ">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/children/profile/detail/'.$med->code); ?>"><?php echo $med->child_name; ?> Profile </a></li>
                            <?php } ?>
        ...
        function delete_medical_history(id){
          ...
          $.post('<?php echo base_url('admin/children/medical_history/delete'); ?>', {"del_id": del_id}, function(data){
                ...
                <div class="tab-content">
                            ...
                            <table class="table table-hover table-vcenter table-striped mb-0 text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url('admin/children/profile/detail/'.strtolower($med->code)); ?>"><span class="font-16"><?php echo $med->child_name; ?></span></a></td>
                    ...
                    <div class="tab-pane" id="Children-add">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/children/medical_history/add'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
