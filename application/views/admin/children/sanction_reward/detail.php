...
<title><?php echo $sanction->title; ?> Sanction or Reward || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/children/sanction_reward/view/'.$sanction->code); ?>">Sanction or Rewards </a></li>
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <br><br>
                                            <!--<div class="pull-right"><a href="< ?php echo base_url('admin/children/sanction_reward/download/'.$sanction->id); ?>" target="_blank">Download</a></div>
                                            <br><br>-->
                                            <div class="pull-right"><a href="<?php echo site_url("admin/children/sanction_reward/edit/$sanction->id/$sanction->code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="timeline_item ">
                                            <form action="<?php echo base_url('admin/children/sanction_reward/send_mail/'.$sanction->id.'/'.$sanction->code); ?>" method="POST">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            <form action="<?php echo base_url('admin/generate_pdf/sanction_reward/'.$sanction->code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="timeline_item ">
                                            <form action="<?php echo base_url('admin/children/sanction_reward/edit_document/'.$sanction->id.'/'.$sanction->code); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
