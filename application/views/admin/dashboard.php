...
<title>Admin || Dashboard || Harold</title>
...
<div id="main_content">
  <?php $this->load->view('menu/admin/nav.php'); ?>
                                        ...
                                        <table class="table card-table table-vcenter text-nowrap table-striped mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('admin/children/profile/detail/'.$child->code); ?>">
                                                            <div><?php echo $child->fullname; ?></div>
                                                        </a>
                                                    </td>
                                                    <td><?php echo $child->gender; ?></td>
                                                    <td><?php echo $child->age; ?></td>
                                                    <td><a href="<?php echo site_url('admin/children/profile/detail/'.$child->code); ?>">View</a></td>
                                                </tr>
                                                <?php } } ?>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table card-table table-vcenter text-nowrap table-striped mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('admin/user/profile/'.$stf->id.'/'.$stf->code); ?>">
                                                            <div><?php echo $stf->firstname; ?> <?php echo $stf->lastname; ?></div>
                                                        </a>
                                                    </td>
                                                    <td><?php echo $stf->telephone; ?></td>
                                                    <td><?php echo $stf->city; ?></td>
                                                    <td><a href="<?php echo site_url('admin/user/profile/'.$stf->id.'/'.$stf->code); ?>">View</a></td>
                                                </tr>
                                                <?php } } ?>
                                            </tbody>
                                        </table>
