                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/health_safety'); ?>">Health & Safety checks </a></li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <br><br>
                                            <div class="pull-right"><a href="<?php echo base_url('admin/health_safety/download/'.$det->id); ?>" target="_blank">Download</a></div>
                                            <br><br>
                                            
                                            <div class="pull-right"><a href="<?php echo site_url("admin/health_safety/edit/$det->id/$det->code"); ?>">Edit</a></div>
                                            <br><br>
                                            <form action="<?php echo base_url('admin/health_safety/send_mail'); ?>" method="POST">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/health_safety/edit_image1/$det->id/$det->code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/health_safety/edit_image2/$det->id/$det->code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/health_safety/edit_image3/$det->id/$det->code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/health_safety/edit_image4/$det->id/$det->code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/health_safety/edit_image5/$det->id/$det->code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
