...
<title>Edit <?php echo $health->title; ?> Health & Safety check || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/health_safety'); ?>">Health & Safety check</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Health-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("admin/health_safety/edit/$health->id/$health->code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
