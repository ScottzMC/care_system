                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="Handover-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("admin/house/handover/add/$code"); ?>" method="post">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <br>
                                                <label>Ingoing staff <span class="text-danger">*</span></label>
                                                <select name="ingoing_staff" class="form-control">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label>Any other information?(Passwords, PC)</label>
                                                <textarea name="additional_info" class="form-control" rows="5" cols="5" aria-label="With textarea"></textarea>
                                            </div>
                                        </div>
