                    ...
                    <script>
                        $(function(){
                          $('#downloadable').click(function(){
                             ...
                             window.location.href = "<?php echo site_url('admin/house/health_safety/download') ?>?file_name="+ $(this).attr('href');
                          });
                        });
                    </script>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="timeline_item ">
                                            <form action="<?php echo base_url('admin/house/health_safety/send_mail/'.$det->id.'/'.$code); ?>" method="POST">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            <form action="<?php echo base_url('admin/generate_pdf/health_safety/'.$det->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="timeline_item ">
                                            <form action="<?php echo base_url('admin/house/health_safety/edit_document/'.$det->id.'/'.$code); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/health_safety/edit_image1/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/health_safety/edit_image2/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/health_safety/edit_image3/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/health_safety/edit_image4/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/health_safety/edit_image5/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
