...
<title>Edit Photo 3 Health & Safety checks || admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/house/health_safety/detail/'.$health->id.'/'.$code); ?>"><?php echo $health->child_name; ?></a> Health & Safety</li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Keywork-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("admin/house/health_safety/edit_image3/$health->id/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
