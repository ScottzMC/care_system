...
<title>Edit Photo 3 Keywork Session || Admin || Harold</title>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Keywork-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("admin/house/keywork_session/edit_image3/$keywork->id/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
