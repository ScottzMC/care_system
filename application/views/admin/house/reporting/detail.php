...
<title><?php echo $det->title; ?> || Reporting || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a href="<?php echo site_url('admin/house/reporting/view/'.strtolower($code)); ?>">Reporting</a></li>
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="timeline_item ">
                                            <form action="<?php echo base_url('admin/house/reporting/send_mail/'.$det->id.'/'.$code); ?>" method="POST">
                            ...
                            <div class="col-xl-8 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            <form action="<?php echo base_url('admin/generate_pdf/reporting/'.$det->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                            ...
                            <div class="col-xl-8 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="timeline_item ">
                                            <form action="<?php echo base_url('admin/house/reporting/edit_document/'.$det->id.'/'.$code); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <br>
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/reporting/summary/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/reporting/area_of_risk/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/reporting/keywork_session/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/reporting/self_care/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/reporting/education/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/reporting/independent_skill/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/reporting/family/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/reporting/missing/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/reporting/area_of_progress/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/reporting/staff/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/reporting/social_worker/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("admin/house/reporting/duration/$det->id/$code"); ?>">Edit</a></div>
                                        </div>
                                    </div>
