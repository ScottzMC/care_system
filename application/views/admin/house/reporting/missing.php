...
<title> Unauthorised Absences/Missing/Legal Reporting || Admin || Harold</title>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Bi-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("admin/house/reporting/missing/$report->id/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
