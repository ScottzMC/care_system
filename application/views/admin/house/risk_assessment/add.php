                    ...
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                          <li class="breadcrumb-item"><a href="<?php echo site_url('admin/dashboard'); ?>">Dashboard</a></li>
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo site_url('admin/house/risk_assessment/view/'.strtolower($code)); ?>">Risk Assessment</a></li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Risk-add">Add Risk Assessment</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="section-body mt-4">
            <div class="container-fluid">
                <div class="tab-content">
                    <div class="tab-pane active" id="Risk-add">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Add Risk Assessment</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/house/risk_assessment/add/'.$code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Criminal/Offending Behaviour Risk Level<span class="text-danger">*</span></label>
                                                <select class="form-control" name="criminal_level">
                                                    <option>Select</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Violent toward others Risk Level <span class="text-danger">*</span></label>
                                                <select class="form-control" name="violent_level">
                                                    <option>Select</option>
                                                    <option value="Low">Low</option>
                                                    <option value="Medium">Medium</option>
                                                    <option value="High">High</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Use of weapons Risk Level <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Behaviour in the community Risk Level <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Bully Risk Level <span class="text-danger">*</span></label>
                                                <select class="form-control" name="bully_level">
                                                    <option>Select</option>
                                                    <option value="Low">Low</option>
                                                    <option value="Medium">Medium</option>
                                                    <option value="High">High</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Discrimination Risk Level <span class="text-danger">*</span></label>
                                                <select class="form-control" name="discrimination_level">
                                                    <option>Select</option>
                                                    <option value="Low">Low</option>
                                                    <option value="Medium">Medium</option>
                                                    <option value="High">High</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Damage to property Risk Level  <span class="text-danger">*</span></label>
                                                <select class="form-control" name="damage_property_level">
                                                    <option>Select</option>
                                                    <option value="Low">Low</option>
                                                    <option value="Medium">Medium</option>
                                                    <option value="High">High</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Arson Risk Level  <span class="text-danger">*</span></label>
                                                <select class="form-control" name="arson_level">
                                                    <option>Select</option>
                                                    <option value="Low">Low</option>
                                                    <option value="Medium">Medium</option>
                                                    <option value="High">High</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Going missing Risk Level <span class="text-danger">*</span></label>
                                                <select class="form-control" name="missing_level">
                                                    <option>Select</option>
                                                    <option value="Low">Low</option>
                                                    <option value="Medium">Medium</option>
                                                    <option value="High">High</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Emotional wellbeing & self-harm <span class="text-danger">*</span></label>
                                                <select class="form-control" name="self_harm_level">
                                                    <option>Select</option>
                                                    <option value="Low">Low</option>
                                                    <option value="Medium">Medium</option>
                                                    <option value="High">High</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Sexual health <span class="text-danger">*</span></label>
                                                <select class="form-control" name="sexual_level">
                                                    <option>Select</option>
                                                    <option value="Low">Low</option>
                                                    <option value="Medium">Medium</option>
                                                    <option value="High">High</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Health & Medication Risk Level<span class="text-danger">*</span></label>
                                                <select class="form-control" name="medication_level">
                                                    <option>Select</option>
                                                    <option value="Low">Low</option>
                                                    <option value="Medium">Medium</option>
                                                    <option value="High">High</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Family & Friend Contacts Risk Level<span class="text-danger">*</span></label>
                                                <select class="form-control" name="family_level">
                                                    <option>Select</option>
                                                    <option value="Low">Low</option>
                                                    <option value="Medium">Medium</option>
                                                    <option value="High">High</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Allegations <span class="text-danger">*</span></label>
                                                <select class="form-control" name="allegation_level">
                                                    <option>Select</option>
                                                    <option value="Low">Low</option>
                                                    <option value="Medium">Medium</option>
                                                    <option value="High">High</option>
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Travel in vehicle <span class="text-danger">*</span></label>
                                                <select class="form-control" name="travel_level">
                                                    <option>Select</option>
                                                    <option value="Low">Low</option>
                                                    <option value="Medium">Medium</option>
                                                    <option value="High">High</option>
