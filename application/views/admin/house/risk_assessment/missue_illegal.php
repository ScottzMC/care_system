...
<title> Misuse of illegal substances/alcohol/smoking || Admin || Harold</title>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Risk-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("admin/house/risk_assessment/missue_illegal/$risk->id/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="missue_illegal_risk_level" class="form-control" aria-label="With textarea"><?php echo $risk->missue_illegal_risk_level; ?></textarea>
                                            </div>
                                        </div>
