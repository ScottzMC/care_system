...
<title> Violent toward others || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Violent toward others</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Risk-edit">Edit Violent toward others</a></li>
                    ...
                    <div class="tab-pane active" id="Risk-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Violent toward others</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url("admin/house/risk_assessment/violent_other/$risk->id/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Violent toward others <span class="text-danger">*</span></label>
                                                <select class="form-control" name="violent_level">
                                                    <option value="<?php echo $risk->violent_level; ?>"><?php echo $risk->violent_level; ?></option>
