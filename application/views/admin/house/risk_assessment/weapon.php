...
<title> Use of weapons || Admin || Harold</title>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Risk-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("admin/house/risk_assessment/weapon/$risk->id/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="weapon_risk_level" class="form-control" aria-label="With textarea"><?php echo $risk->weapon_risk_level; ?></textarea>
                                            </div>
                                        </div>
