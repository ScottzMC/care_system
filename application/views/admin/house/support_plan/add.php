                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="Support-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/house/support_plan/add/'.$code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                    ...
                    <div class="tab-pane show" id="Support-areas-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/house/support_plan/area_of_support/'.$code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                            ...
                            <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            ...
                                            <a href="<?php echo site_url('admin/house/support_plan/edit_area_of_support/'.$area->id.'/'.$code); ?>" class="btn btn-primary">Edit</a>
                                            <br><br>
