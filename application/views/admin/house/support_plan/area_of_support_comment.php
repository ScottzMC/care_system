...
<?php foreach($support_comment as $comment){} ?>
<title>Edit <?php echo $comment->title; ?> || Support Plan || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $comment->title; ?></li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Support-edit">Edit <?php echo $comment->title; ?></a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Support-edit">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("admin/house/support_plan/edit_comment/$comment->area_support_id/$comment->code/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
