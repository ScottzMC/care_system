                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="Support-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/house/support_work/add/'.$code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                ...
                                <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                ...
                                                <a href="<?php echo site_url('admin/house/support_work/edit_task/'.$tsk->id.'/'.$code); ?>" class="btn btn-primary">Edit</a>
                                                <br><br>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/house/support_work/add_subtask/'.$code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Task <span class="text-danger">*</span></label>
                                ...
                                <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                ...
                                                <a href="<?php echo site_url('admin/house/support_work/edit_subtask/'.$tsk->id.'/'.$code); ?>" class="btn btn-primary">Edit</a>
                                                <br><br>
