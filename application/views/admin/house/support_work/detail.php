...
<title><?php echo $det->title; ?> || Support Work || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a href="<?php echo site_url('admin/house/support_work/view/'.strtolower($code)); ?>">Support Work</a></li>
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
										<ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                <b>Action</b>
                                                <div class="pull-right"><a href="<?php echo site_url("admin/house/support_work/edit/$det->id/$code"); ?>">Edit</a></div>
                                            </li>
                                        </ul>
                                    </div>
                                    <?php } } ?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="timeline_item ">
                                            <form action="<?php echo base_url('admin/house/support_work/send_mail/'.$det->id.'/'.$code); ?>" method="POST">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            <form action="<?php echo base_url('admin/generate_pdf/support_work/'.$det->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="timeline_item ">
                                            <form action="<?php echo base_url('admin/house/support_work/edit_document/'.$det->id.'/'.$code); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
