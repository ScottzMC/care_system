                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane show" id="Risk-all">
                        ...
                        function delete_risk_assessment(id){
                          ...
                          $.post('<?php echo base_url('admin/house/risk_assessment/delete'); ?>', {"del_id": del_id}, function(data){
                            alert('Deleted Successfully');
                            location.reload();
                            $('#ctr').html(data)
                            });
                          ...
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Title</th>
                                        <th>Date</th>
                                        <th><a href="<?php echo base_url('admin/house/risk_assessment/add/'.$code); ?>">Add</a></th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                  <?php if($risk_assessment){ foreach($risk_assessment as $risk){ ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url("admin/children/profile/detail/$risk->code"); ?>"><span class="font-16"><?php echo $risk->child_name; ?></span></a></td>
                                        <td><a href="<?php echo site_url("admin/house/risk_assessment/detail/$risk->id/$code"); ?>"><span class="font-16"><?php echo $risk->title; ?></span></a></td>
                                        <td><?php echo date('l, dS M Y',strtotime($risk->created_date)); ?></td>
                                        <td>
                                        <a href="<?php echo base_url('admin/house/risk_assessment/add/'.$code); ?>">Add</a>
                                        </td>
                          ...
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Topic</th>
                                        <th>Date</th>
                                        <th><a href="<?php echo site_url('admin/house/support_work/add/'.$code); ?>">Add</a></th>
                                        <th>Action</th>
                                        <th>Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                  <?php if($support_work){ foreach($support_work as $work){ ?>
                                    <tr>
                                        <td><a href="<?php echo site_url('admin/children/detail/'.$work->code); ?>"><span class="font-16"><?php echo $work->child_name; ?></span></a></td>
                                        <td><a href="<?php echo site_url('admin/support_work/detail/'.$work->id.'/'.$code); ?>"><span class="font-16"><?php echo $work->title; ?></span></a></td>
                                        <td><?php echo $work->house_name; ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($work->created_date)); ?></td>
                                        <td><a href="<?php echo site_url('admin/house/support_work/add/'.$code); ?>">Add</a></td>
                                        <td><a href="<?php echo site_url('admin/house/support_work/edit/'.$work->id.'/'.$code); ?>">Edit</a></td>
                    ...
                    <div class="tab-pane show" id="Staff-Communication-all">
                        ...
                        function delete_staff_communication(id){
                          ...
                          $.post('<?php echo base_url('admin/house/staff_communication/delete'); ?>', {"del_id": del_id}, function(data){
                            alert('Deleted Successfully');
                            location.reload();
                            $('#cti').html(data)
                            });
                    ...
                    <div class="tab-pane show" id="Handover-all">
                        ...
                        function delete_handover(id){
                          ...
                          $.post('<?php echo base_url('admin/house/handover/delete'); ?>', {"del_id": del_id}, function(data){
                            alert('Deleted Successfully');
                            location.reload();
                            $('#cti').html(data)
                            });
                        ...
                        <div class="table-responsive">
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  ...
                                  ?>
                                    <tr>
                                        <td><a href="<?php echo site_url("admin/house/handover/detail/$hand->id/$code"); ?>"><span class="font-16"><?php echo $hand->title; ?></span></a></td>
