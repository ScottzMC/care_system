...
<title>Edit <?php echo $staff->title; ?> Staff Shift || Admin || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/staff_shift'); ?>">Staff Shift</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo site_url('admin/staff_shift/detail/'.$staff->id); ?>"><?php echo $staff->title; ?> Info</a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Staff-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("admin/staff_shift/edit/$staff->id"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
