...
<title>Staff Shift || Admin || Harold</title>
                ...
                <div class="tab-content">
                    ...
                    <script>
                        function delete_staff_shift(id){
                          ...
                          $.post('<?php echo base_url('admin/staff_shift/delete_event'); ?>', {"del_id": del_id}, function(data){
                          ...
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  <?php if($staff_shift){ foreach($staff_shift as $shift){ ?>
                                    <tr>
                                        <td><a href="<?php echo site_url("admin/staff_shift/detail/$shift->id"); ?>"><span class="font-16"><?php echo $shift->title; ?></span></a></td>
                                        ...
                                        <td><?php echo date('l, dS M Y',strtotime($shift->end_date)); ?></td>
                                        <td><a href="<?php echo site_url("admin/staff_shift/detail/$shift->id"); ?>">View</a></td>
                    ...
                    <div class="tab-pane show" id="Staff-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/staff_shift/add'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
