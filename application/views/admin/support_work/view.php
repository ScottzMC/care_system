                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Support-all">
                        ...
                        function delete_support_work(id){
                          ...
                          $.post('<?php echo base_url('admin/support_work/delete'); ?>', {"del_id": del_id}, function(data){
                        ...
                        function delete_task(id){
                          ...
                          $.post('<?php echo base_url('admin/support_work/delete_task'); ?>', {"del_id": del_id}, function(data){
                            alert('Deleted Successfully');
                            location.reload();
                            $('#cti').html(data)
                            });
                        ...
                        function delete_subtask(id){
                          var del_id = id;
                          if(confirm("Are you sure you want to delete this task")){
                          $.post('<?php echo base_url('admin/support_work/delete_subtask'); ?>', {"del_id": del_id}, function(data){
                            alert('Deleted Successfully');
                            location.reload();
                            $('#cti').html(data)
                            });
                                ...
                                <tbody>
                                  <?php if($support_work){ foreach($support_work as $support){ ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url('admin/children/detail/'.$support->code); ?>"><span class="font-16"><?php echo $support->child_name; ?></span></a></td>
                                        <td><a href="<?php echo site_url('admin/support_work/detail/'.$support->id); ?>"><span class="font-16"><?php echo $support->title; ?></span></a></td>
                                        <td><?php echo $support->house_name; ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($support->created_date)); ?></td>
                                        <td><a href="<?php echo site_url('admin/support_work/edit/'.$support->id); ?>">Edit</a></td>
                    ...
                    <div class="tab-pane show" id="Support-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/support_work/add'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/support_work/add_task'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Task <span class="text-danger">*</span></label>
                                ...
                                <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                ...
                                                <a href="<?php echo site_url('admin/support_work/edit_task/'.$tsk->id); ?>" class="btn btn-primary">Edit</a>
                                                <br><br>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('admin/support_work/add_subtask'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Task <span class="text-danger">*</span></label>
                                ...
                                <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                ...
                                                <a href="<?php echo site_url('admin/support_work/edit_subtask/'.$tsk->id); ?>" class="btn btn-primary">Edit</a>
                                                <br><br>
