...
<title><?php echo $det->title; ?> || Daily Log || HR || Harold</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            ...
                                            <div class="pull-right"><a href="<?php echo site_url("hr/daily_log/edit/$det->id"); ?>">Edit</a></div>
                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            <form action="<?php echo base_url('hr/daily_log/send_mail'); ?>" method="POST">
                                                <div class="msg">
