...
<title>Edit <?php echo $daily->title; ?> Daily Log || HR || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('hr/daily_log'); ?>">Daily Log</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo site_url('hr/daily_log/detail/'.$daily->id); ?>"><?php echo $daily->title; ?></a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit <?php echo $daily->title; ?></li>
                        </ol>
                    </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Daily-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("hr/daily_log/edit/$daily->id"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
