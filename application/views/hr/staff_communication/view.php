...
<title>Staff Communication || HR || Harold</title>
                    ...
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                          <li class="breadcrumb-item"><a href="<?php echo site_url('hr/dashboard'); ?>">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Staff Communication</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Staff-all">View All Staff Communication</a></li>
                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Staff-add">Add Staff Communication</a></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Staff-all">
                        ...
                        function delete_staff_communication(id){
                          ...
                          $.post('<?php echo base_url('hr/staff_communication/delete'); ?>', {"del_id": del_id}, function(data){
                          ...
                          <table class="table table-hover table-vcenter text-nowrap js-basic-example dataTable table-striped table_custom border-style spacing5">
                                ...
                                <tbody>
                                  <?php if($staff_communication){ foreach($staff_communication as $staff){ ?>
                                    <tr>
                                        <td><a href="<?php echo site_url("hr/staff_communication/detail/$staff->id"); ?>"><span class="font-16"><?php echo $staff->title; ?></span></a></td>
                                        ...
                                        <td><a href="<?php echo site_url("hr/staff_communication/edit/$staff->id"); ?>">Edit</a></td>
                    ...
                    <div class="tab-pane show" id="Staff-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('hr/staff_communication/add'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
