...
<title><?php echo $det->title; ?> || Training Calendar || HR || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('hr/training'); ?>">Training Calendar </a></li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
										<ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                <b>Send Mail</b>
                                                <form action="<?php echo base_url('hr/training/send_mail'); ?>" method="POST">
