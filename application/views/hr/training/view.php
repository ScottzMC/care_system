...
<title>Training Calendar || HR || Harold</title>
                ...
                <div class="tab-content">
                                ...
                                <tbody>
                                  <?php if($training){ foreach($training as $train){ ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url("hr/training/detail/$train->id"); ?>"><span class="font-16"><?php echo $train->title; ?></span></a></td>
                                        <td><?php echo character_limiter($train->body, 100); ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($train->start_date)); ?></td>
                                        <td><a href="<?php echo site_url("hr/training/detail/$train->id"); ?>">View</a></td>
                    ...
                    <div class="tab-pane show" id="Training-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('hr/training/add'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                    ...
                    <script>
                        function delete_training(id){
                          ...
                          $.post('<?php echo base_url('hr/training/delete_event'); ?>', {"del_id": del_id}, function(data){
