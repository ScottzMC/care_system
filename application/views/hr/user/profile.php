...
<title><?php echo $prof->firstname; ?> <?php echo $prof->lastname; ?> || User || HR || Harold</title>
    ...
    <div class="page">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('hr/user'); ?>">User </a></li>
        ...
        $(function(){
          $('#downloadable').click(function(){
             ...
             window.location.href = "<?php echo site_url('hr/user/download') ?>?file_name="+ $(this).attr('href');
          });
        });
        </script>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
										<ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                <b>Document</b>
                                                <div class="pull-right"><a href="<?php echo base_url('hr/user/download/'.$prof->id); ?>" target="_blank">Download</a></div></li>
                                            <li class="list-group-item">
                                                <b>Action</b>
                                                <div class="pull-right"><a href="<?php echo site_url("hr/user/edit/$prof->id/$prof->code"); ?>">Edit</a></div>
                                            </li>
                                        </ul>
                                    </div>
                                    <?php } ?>
                                    ...
                                    <div class="card-body">
										<ul class="list-group">
                                            <li class="list-group-item">
                                                ...
                                                <div class="pull-right"><a href="<?php echo base_url('hr/user/form_download_passport/'.$fil->code); ?>" target="_blank">Download</a></div>
                                                <?php } ?>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Driving License </b>
                                                <?php if(!empty($fil->driving_license)){ ?>
                                                <div class="pull-right"><a href="<?php echo base_url('hr/user/form_download_driving/'.$fil->code); ?>" target="_blank">Download</a></div>
                                                <?php } ?>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Proof of Address 1 </b>
                                                <?php if(!empty($fil->address1)){ ?>
                                                <div class="pull-right"><a href="<?php echo base_url('hr/user/form_download_address1/'.$fil->code); ?>" target="_blank">Download</a></div>
                                                <?php } ?>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Proof of Address 2 </b>
                                                <?php if(!empty($fil->address2)){ ?>
                                                <div class="pull-right"><a href="<?php echo base_url('hr/user/form_download_address2/'.$fil->code); ?>" target="_blank">Download</a></div>
                                                <?php } ?>
                                            </li>
                                            <li class="list-group-item">
                                                <b>DBS Certificate</b>
                                                <?php if(!empty($fil->dbs_certificate)){ ?>
                                                <div class="pull-right"><a href="<?php echo base_url('hr/user/form_download_dbs/'.$fil->code); ?>" target="_blank">Download</a></div>
                                                <?php } ?>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Proof of Qualification</b>
                                                <?php if(!empty($fil->qualification)){ ?>
                                                <div class="pull-right"><a href="<?php echo base_url('hr/user/form_download_proof/'.$fil->code); ?>" target="_blank">Download</a></div>
                                                <?php } ?>
                                            </li>
                                            <li class="list-group-item">
