...
<title>View Users || HR || Harold</title>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Users-all">
                        ...
                        function delete_user(id){
                          ...
                          $.post('<?php echo base_url('hr/user/delete'); ?>', {"del_id": del_id}, function(data){
                                ...
                                <tbody>
                                  <?php if($users){ foreach($users as $usr){ ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= site_url("hr/user/profile/$usr->id/$usr->code"); ?>">
                                                <span class="font-16">
                                        ...
                                        <td><a href="<?= site_url("hr/user/profile/$usr->id/$usr->code"); ?>">View</a></td>
                                        <td><a href="<?php echo site_url('hr/user/edit/'.$usr->id.'/'.$usr->code); ?>">Edit</a></td>
                    ...
                    <div class="tab-pane show" id="Users-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('hr/user/add'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
