                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Printout-edit">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('staff/children/abilities_evaluation/edit/'.$abilities->id.'/'.$abilities->code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
