...
<title>Edit <?php echo $case->child_name; ?> Young People || staff || Harold</title>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Printout-edit">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('staff/children/case_recording/edit/'.$case->id.'/'.$case->code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
