...
<div id="main_content">
    ...
    <div class="page">
        ...
        function delete_absences(id){
          ...
          $.post('<?php echo base_url('staff/children/edt/delete'); ?>', {"del_id": del_id}, function(data){
        ...
        $(function(){
          $('#downloadable').click(function(){
             ...
             window.location.href = "<?php echo site_url('staff/children/edt/download') ?>?file_name="+ $(this).attr('href');
          });
        });
                ...
                <div class="tab-content">
                            ...
                            <table class="table table-hover table-vcenter table-striped mb-0 text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url('staff/children/profile/detail/'.strtolower($abs->code)); ?>"><span class="font-16"><?php echo $abs->child_name; ?></span></a></td>
                    ...
                    <div class="tab-pane" id="Children-add">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('staff/children/edt/add'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
