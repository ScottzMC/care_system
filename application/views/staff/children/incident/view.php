...
<div id="main_content">
    ...
    <div class="page">
        ...
        function delete_incident(id){
          ...
          $.post('<?php echo base_url('staff/children/incident/delete'); ?>', {"del_id": del_id}, function(data){
                ...
                <div class="tab-content">
                            ...
                            <table class="table table-hover table-vcenter table-striped mb-0 text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url('staff/children/profile/detail/'.strtolower($inc->code)); ?>"><span class="font-16"><?php echo $inc->child_name; ?></span></a></td>
                                        <td><a href="<?php echo site_url('staff/children/incident/detail/'.strtolower($inc->id).'/'.strtolower($inc->code)); ?>"><?php echo $inc->title; ?></a></td>
                                        <td><?php echo character_limiter($inc->body, 50); ?></td>
                                        <td><?php echo date('l, dS M Y',strtotime($inc->created_date)); ?></td>
                                        <!--<td>
                                        < ?php if(!empty($incident)){ ?>
                                        <a href="< ?php echo base_url('staff/children/incident/download/'.$inc->id); ?>" target="_blank">Download</a>
                                        < ?php }else{ echo ''; } ?>
                                        </td>-->
                                        <td>
                                            <a href="<?php echo site_url('staff/children/incident/detail/'.strtolower($inc->id).'/'.strtolower($inc->code)); ?>" class="btn btn-icon btn-sm" title="View"><i class="fa fa-eye"></i></a>
                                            <a href="<?php echo site_url('staff/children/incident/edit/'.strtolower($inc->id).'/'.strtolower($inc->code)); ?>" class="btn btn-icon btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                    ...
                    <div class="tab-pane" id="Children-add">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('staff/children/incident/add'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="child_code">
                                                    ...
                                                    <option value="<?php echo $inc->code; ?>"><?php echo $inc->child_name; ?></option>
                                                </select>
                                            </div>
                                        </div>
