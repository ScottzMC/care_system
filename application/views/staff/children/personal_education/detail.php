...
<title><?php echo $edu->title; ?> Personal Education || staff || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('staff/children/personal_education/view/'.$edu->code); ?>">Personal Education </a></li>
                        ...
                        <div class="row">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <br><br>
                                            <div class="pull-right"><a href="<?php echo base_url('staff/children/personal_education/download/'.$edu->id); ?>" target="_blank">Download</a></div>
                                            <br><br>
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="timeline_item ">
                                            <form action="<?php echo base_url('staff/children/personal_education/send_mail/'.$edu->id.'/'.$edu->code); ?>" method="POST">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item">
                                            <form action="<?php echo base_url('staff/generate_pdf/personal_education/'.$edu->code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                            ...
                            <div class="col-xl-8 col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="timeline_item ">
                                            <form action="<?php echo base_url('staff/children/personal_education/edit_document/'.$edu->id.'/'.$edu->code); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
