...
<div id="main_content">
    ...
    <div class="page">
        ...
        function delete_children(id){
          ...
          $.post('<?php echo base_url('staff/children/profile/delete'); ?>', {"del_id": del_id}, function(data){
                ...
                <div class="tab-content">
                            ...
                            <table class="table table-hover table-vcenter table-striped mb-0 text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url('staff/children/profile/detail/'.strtolower($child->code)); ?>"><span class="font-16"><?php echo $child->fullname; ?></span></a></td>
                                        ...
                                        <td>
                                            <a href="<?php echo site_url('staff/children/profile/detail/'.strtolower($child->code)); ?>" class="btn btn-icon btn-sm" title="View"><i class="fa fa-eye"></i></a>
                                            <a href="<?php echo site_url('staff/children/profile/edit/'.strtolower($child->code)); ?>" class="btn btn-icon btn-sm" title="Edit"><i class="fa fa-edit"></i></a>
                    ...
                    <div class="tab-pane" id="Children-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('staff/children/profile/add'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
