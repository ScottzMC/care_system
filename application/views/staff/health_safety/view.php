                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Health-all">
                        ...
                        function delete_health_safety(id){
                          ...
                          $.post('<?php echo base_url('staff/health_safety/delete'); ?>', {"del_id": del_id}, function(data){
                                ...
                                <tbody>
                                  <?php if($health_safety){ foreach($health_safety as $health){ ?>
                                    <tr>
                                        ...
                                        <a href="<?php echo base_url('staff/health_safety/download/'.$health->id); ?>" target="_blank">Download</a>
                                        <?php }else{ echo ''; } ?>
                                        </td>
                                        <td><a href="<?php echo site_url("staff/health_safety/edit/$health->id/$health->code"); ?>">Edit</a></td>
                    ...
                    <div class="tab-pane show" id="Health-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('staff/health_safety/add'); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
