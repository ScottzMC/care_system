...
<title>Guest Ban || staff || Harold</title>
                    ...
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                          <li class="breadcrumb-item"><a href="<?php echo site_url('staff/dashboard'); ?>">Dashboard</a></li>
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo site_url('staff/house/guest_ban/view/'.strtolower($code)); ?>">Guest Ban</a></li>
                        </ol>
                    </div>
                                ...
                                <tbody>
                                  <?php if($guest_ban){ foreach($guest_ban as $guest){ ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url("staff/house/guest_ban/detail/$guest->id/$code"); ?>">View</a></td>
