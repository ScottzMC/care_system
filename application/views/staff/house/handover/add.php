                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Ingoing-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("staff/house/handover/ingoing/$code"); ?>" method="post">
                                    <div class="row">
                    ...
                    <div class="tab-pane show" id="Outgoing-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("staff/house/handover/outgoing/$code"); ?>" method="post">
                                    <div class="row">
