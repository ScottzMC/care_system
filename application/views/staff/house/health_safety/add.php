                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Health-add">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url('staff/house/health_safety/add/'.$code); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea cols="10" cols="10" name="additional_info" class="form-control" aria-label="With textarea"></textarea>
                                            </div>
                                        </div>
