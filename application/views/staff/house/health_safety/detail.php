                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="timeline_item ">
                                            ...
                                            <br><br>
                                            <form action="<?php echo base_url('staff/house/health_safety/send_mail/'.$code); ?>" method="POST">                                  <input class="form-control" type="email" name="email" placeholder="Email Address">
