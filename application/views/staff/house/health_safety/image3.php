...
<title>Edit Photo 3 Health & Safety checks || staff || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('staff/house/health_safety/detail/'.$health->id.'/'.$code); ?>"><?php echo $health->child_name; ?></a> Health & Safety</li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Photo 3</li>
                        </ol>
                    </div>

                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Keywork-edit">Edit Photo 3</a></li>
                    ...
                    <div class="tab-pane active" id="Keywork-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Photo 3</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url("staff/house/health_safety/edit_image3/$health->id/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
