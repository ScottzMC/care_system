...
<title>Edit <?php echo $keywork->title; ?> Keywork Session || staff || Harold</title>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Keywork-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("staff/house/keywork_session/edit/$keywork->id/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="staff_initial" class="form-control" value="<?php echo $keywork->staff_initial; ?>">
                                            </div>
                                        </div>
