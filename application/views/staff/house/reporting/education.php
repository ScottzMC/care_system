...
<title> Education/Employment/Training Reporting || staff || Harold</title>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Bi-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("staff/house/reporting/education/$report->id/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
