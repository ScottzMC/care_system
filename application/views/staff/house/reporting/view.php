...
<title>Reporting || staff || Harold</title>
                    ...
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                          <li class="breadcrumb-item"><a href="<?php echo site_url('staff/dashboard'); ?>">Dashboard</a></li>
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo site_url('staff/house/reporting/view/'.strtolower($code)); ?>">Reporting</a></li>
                        </ol>
                    </div>
