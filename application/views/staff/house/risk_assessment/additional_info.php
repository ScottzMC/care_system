...
<title>Additional Information || staff || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Risk-edit">Edit Additional Info</a></li>
                    ...
                    <div class="tab-pane active" id="Risk-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Additional Info</h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url("staff/house/risk_assessment/edit_additional_info/$risk->id/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
