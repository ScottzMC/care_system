...
<title> Behaviour in the community || staff || Harold</title>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Risk-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("staff/house/risk_assessment/behaviour_community/$risk->id/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="behaviour_community_risk_level" class="form-control" aria-label="With textarea"><?php echo $risk->behaviour_community_risk_level; ?></textarea>
                                            </div>
                                        </div>
