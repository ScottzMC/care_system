...
<title> Travel in vehicle || staff || Harold</title>
            ...
            <div class="container-fluid">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <ul class="nav nav-tabs page-header-tab">
                        <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Risk-edit">Edit Travel in vehicle</a></li>
                    ...
                    <div class="tab-pane active" id="Risk-edit">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Travel in vehicle </h3>
                            </div>
                            <div class="card-body">
                                <form action="<?php echo base_url("staff/house/risk_assessment/travel/$risk->id/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-12">
                                            <div class="form-group">
                                                <label>Travel in vehicle Risk Level<span class="text-danger">*</span></label>
                                                <select class="form-control" name="travel_level">
                                                    <option value="<?php echo $risk->travel_level; ?>"><?php echo $risk->travel_level; ?></option>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea cols="10" rows="10" name="travel_risk_level" class="form-control" aria-label="With textarea"><?php echo $risk->travel_risk_level; ?></textarea>
                                            </div>
                                        </div>
