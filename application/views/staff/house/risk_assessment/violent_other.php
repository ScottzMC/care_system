...
<title> Violent toward others || staff || Harold</title>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Risk-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("staff/house/risk_assessment/violent_other/$risk->id/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
