...
<title><?php echo $det->title; ?> || Staff communication || staff || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a href="<?php echo site_url('staff/house/staff_communication/view/'.strtolower($code)); ?>">Staff Communication</a></li>
                            ...
                            <div class="col-xl-8 col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="timeline_item ">
                                                <form action="<?php echo base_url('staff/house/staff_communication/send_mail/'.$det->id.'/'.$code); ?>" method="POST">
                                ...
                                <div class="col-xl-8 col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="timeline_item">
                                                <form action="<?php echo base_url('staff/generate_pdf/staff_communication/'.$det->id); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                ...
                                <div class="col-xl-8 col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="timeline_item ">
                                                <form action="<?php echo base_url('staff/house/staff_communication/edit_document/'.$det->id.'/'.$code); ?>" method="POST" enctype="multipart/form-data" accept-charset="UTF-8">
