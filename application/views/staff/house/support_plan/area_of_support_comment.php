...
<title>Edit <?php echo $comment->title; ?> || Support Plan || staff || Harold</title>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Support-edit">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("staff/house/support_plan/edit_comment/$comment->area_support_id/$comment->code/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
