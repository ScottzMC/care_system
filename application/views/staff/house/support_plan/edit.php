...
<title>Edit <?php echo $support->title; ?> Support Plan || staff || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('staff/house/support_plan/detail/'.$support->id.'/'.$code); ?>"><?php echo $support->title; ?></a></li>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="Support-edit">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("staff/house/support_plan/edit/$support->id/$support->code/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="<?php echo base_url("staff/house/support_plan/edit_comment/$support->id/$support->code/$code"); ?>" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                                    <div class="row">
