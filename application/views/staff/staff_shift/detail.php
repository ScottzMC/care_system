...
<title><?php echo $det->title; ?> || Staff Shift || Staff || Harold</title>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div class="header-action">
                        ...
                        <ol class="breadcrumb page-breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="<?php echo site_url('staff/staff_shift'); ?>"> Staff Shift </a></li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
										<ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                <b>Action</b>
                                                <div class="pull-right"><a href="<?php echo site_url("staff/staff_shift/edit/$det->id"); ?>">Edit</a></div>
                                            </li>
                                            <li class="list-group-item">
                                                <b>Send Mail</b>
                                                <form action="<?php echo base_url('staff/staff_shift/send_mail'); ?>" method="POST">
